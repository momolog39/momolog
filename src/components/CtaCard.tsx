      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="text-center sm:text-left">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#06C755] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:opacity-90 transition-opacity"
          >
          ...
          <div className="flex items-center gap-3 mt-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center text-white hover:opacity-80 transition-opacity"
