      ...
      {!compact && (
        <>
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 mt-3 bg-[#06C755] text-white py-2 rounded-lg text-xs font-medium hover:opacity-90 transition-opacity"
          >
          ...
          <div className="flex justify-center gap-3 mt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center text-white hover:opacity-80 transition-opacity"
