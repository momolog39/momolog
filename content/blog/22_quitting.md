...
辞めることが決まったら、最終出勤日までにやっておくべきことがあります。ここを飛ばすと、辞めた後に困ることになります。

**写真・写メ日記の削除を依頼する。** お店のサイトに載っているパネル写真、写メ日記、SNSの投稿。退店時に削除してもらうよう、はっきり依頼してください。「削除されたか」を後日自分で確認することも忘れずに。放置すると、辞めた後も自分の写真がネットに残り続けます。

**貸与品を返却する。** 制服、ロッカーの鍵、備品など。返却漏れがあると、後からトラブルの種になります。

**最後の報酬の受け取り方法を確認する。** 日払いなら問題ないですが、締め払いの場合は「いつ・どうやって受け取るか」を確認。辞めた後に「振り込まれない」というトラブルは実際にあります。

**仕事用SNSアカウントを整理する。** 営業用のXやインスタは、退店後に削除するか、少なくとも顔写真や店名がわかる投稿は消しておく。[身バレ対策](/blog/07_identity_protection)は辞める時まで含めて完結です。

**性病検査を受けておく。** 風俗を離れるタイミングで一度検査を受けて、区切りをつけておくと安心です。
...
[メンエス](/blog/10_menes_alternative)は風俗ではないので、業種を変えたことになります。身体的・精神的な負担も軽くなるし、マッサージの技術は今後のキャリアにも活かせます。
